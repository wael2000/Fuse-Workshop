 ...
 * 2019-02-25T13:57:50.830+04:00
 * Generated source version: 3.1.11.fuse-000281-redhat-3
 * 
 */
@WebServiceClient(name = "HelloService", 
                  wsdlLocation = "http://localhost:8090/service/accountService?wsdl",
...
public class HelloService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8090/service/accountService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8090/service/accountService?wsdl");
        }
        WSDL_LOCATION = url;
    }
